...
namespace Interface.Views.NewGame
{
    ...
    public class ChangeRace1Command : ICommand
    {
        ...
        public ChangeRace1Command(NewGameModel m)
        {
            ngm = m;
        }
        ...
        {
            ngm.Player1Race = ((RaceParameter)o).Name;
            ((System.Windows.Controls.Image)((RaceParameter)o).Image).Source = new BitmapImage(new Uri(ngm.Player1RaceImage, UriKind.Relative));
            ((System.Windows.Controls.TextBox)((RaceParameter)o).TextBox).FontFamily = new FontFamily(ngm.Player1RaceFont);
        }
